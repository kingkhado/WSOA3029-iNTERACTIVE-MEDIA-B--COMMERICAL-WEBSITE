...
function animateCounter(element) {
  ...
  if ((maxValue !== null && counter.textContent === maxValue.toString()) && (maxPercent === null || percent.textContent === maxPercent.toString())) {
    return;
  }
  ...
  const interval = setInterval(() => {
    ...
    if ((maxValue === null || currentValue >= maxValue) && (maxPercent === null || currentPercent >= maxPercent)) {
